      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Silahkan masukkan data dengan format data yang sesuai dengan kriteria yang telah ditentukan, agar hasil perhitungan dan peng-Clusteran bisa berjalan dengan akurat.</p>
			...
			<tr>
				<td>Nilai1</td>
				<td><input type="int" name="x1"></td>					
			</tr>	
			<tr>
				<td>Nilai2</td>
				<td><input type="int" name="x2"></td>					
			</tr>	
			<tr>
				<td></td>
				<td>
                <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" type="submit" value="Simpan">
